...
export const Category = ({ category, icon: Icon }) => {
  ...
  return (
    <div
      className={`shadow-xl flex flex-col gap-4 rounded-2xl ${category.bgColor} group ${category.hoverBgColor} ${category.darkBgColor} ${category.darkHoverBgColor} transition-all active:scale-95 duration-200 cursor-pointer p-4 h-fit w-full`}
