...
export const RecentFileSmall = ({ type, icon: Icon }) => {
  return (
    <div className="shadow p-3 flex min-[580px]:hidden gap-4 items-center justify-between bg-white dark:bg-sky-800 rounded-lg">
